 ...
 */
export const loginHandler = async (c: any): Promise<Response> => {
 ...
 */
export const logoutHandler = async (c: any): Promise<Response> => {
 ...
 */
export const checkAuthRequiredHandler = async (c: any): Promise<Response> => {
    const db = c.get('database');
    const userService = new UserService(db);
 ...
 */
export async function setup2FAHandler(c: Context): Promise<Response> {
    const db = c.get('database');
    const userService = new UserService(db);
    const session = c.get('session');
 ...
 */
export async function enable2FAHandler(c: Context): Promise<Response> {
    const db = c.get('database');
    const userService = new UserService(db);
    const session = c.get('session');
 ...
 * Disable 2FA
 */
export async function disable2FAHandler(c: Context): Promise<Response> {
    const db = c.get('database');
    const userService = new UserService(db);
    const session = c.get('session');
 ...
 */
export async function acceptInviteHandler(c: Context): Promise<Response> {
    const db = c.get('database');
    const userService = new UserService(db);
